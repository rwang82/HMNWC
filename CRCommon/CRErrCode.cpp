...
const int CRERR_SRV_DB_NODATA = CRERR_SRV_BEGIN + 31;
const int CRERR_SRV_DB_DATA_FORMAT_ERROR = CRERR_SRV_BEGIN + 32;
const int CRERR_SRV_PARAM_INVALID = CRERR_SRV_BEGIN + 500;
