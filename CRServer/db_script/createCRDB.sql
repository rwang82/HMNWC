...
create table products(publisher char(20), uuid char(128), title char(100), price char(50), description char(255), images char(255), keyword char(255), status tinyint(1));
